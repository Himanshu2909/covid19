...
module.exports = __webpack_require__("IZN9");
...
/* harmony import */ var bson__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("tgNz");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  if (req.method == "POST") {
    ...
    let posts = await db.collection("posts").aggregate([{
      $match: {
        _id: Object(bson__WEBPACK_IMPORTED_MODULE_2__["ObjectID"])(req.body.post)
      }
    }, {
      $project: {
        username: 1,
