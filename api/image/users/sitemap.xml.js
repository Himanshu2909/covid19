...
module.exports = __webpack_require__("SS+Y");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  const users = await db.collection("userData").aggregate([{
    ...
    let a = await e.map(e => {
      return {
        url: [{
          loc: `https://www.covidresources.me/user/${e.username}`
        }, {
          "image:image": [{
            "image:loc": `https://www.covidresources.me/api/image/users/${e.username}`
          }]
        }]
      };
    });
