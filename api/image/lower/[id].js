...
module.exports = __webpack_require__("6+8t");
...
/* harmony import */ var jimp__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("yQ4v");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  if (posts[0].compressed) {
    ...
    const main = await db.collection("emergency").aggregate([{
      $match: {
        _id: Object(bson__WEBPACK_IMPORTED_MODULE_0__["ObjectID"])("60743b3ae474367382c95633")
      }
    }, {
      $project: {
        compressed: 1
